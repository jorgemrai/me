...
export const metadata = buildPageMetadata("es", "writing");
export const dynamic = "error";

function formatDate(date?: string, locale: "es" | "en" = "es") {
...
export default async function WritingPage() {
  ...
  return (
    <PageShell locale="es" page="writing">
            ...
            {posts.map((post) => (
              <PostCard
                ...
                post={{
                  title: post.title,
                  link: post.link,
                  date: formatDate(post.published, "es"),
